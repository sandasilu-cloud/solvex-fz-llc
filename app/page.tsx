...
>
  <source src="/videos/solvex-intro-cover.webm" type="video/webm" />
  <source src="/videos/solvex-intro-cover.mp4" type="video/mp4" />
</video>
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/40 to-navy-deep" />
